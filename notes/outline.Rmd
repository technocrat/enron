...
Several changes to the `tibble` created are necessary:

1. Change `date` from <chr>  to <date>
2. Strip newlines and double quoted brackets from recipients
3. Collect all senders and receivers and assign a unique numeric identifier^[This will be convenient for graph analysis labels and help minimize analyst bias.]
...
I downloaded the [staff] report and extracted the 6-page Executive Summary.^[This could, and would have been coded in `R` had multiple files been required.] From this, I extracted a list of keywords that indicated the general nature of FERC's inquiry. I deliberated excluded the extensive detail available in the remainder of the report. At the beginning of most ediscovery, the parties seeking review of electronic documents have topi/cs in view, which the Executive Summary provides without biasing the analysis with the results of FERC's review.
