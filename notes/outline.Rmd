...
3. Collect all senders and receivers and assign a unique numeric identifier^[This will be convenient for graph analysis labels and help minimize analysis bias.]

```{r de-bracket recipients}

library(rebus)

# detection patterns to recipient fields tos and ccs
