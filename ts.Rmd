...
`Closeness` measures the geodesic between a vertex and all other vertices in a graph.

```{r, echo=FALSE}
kable(clos(Qall,10)) %>%   kable_styling(bootstrap_options = "striped", full_width = F, position = "center")
...
Which of these measures to privilege is not clear. They each present different perspectives of the relative importance of userd in the network, based on different criteria, but none fails to identify any collection of users to which attention should be directed.
